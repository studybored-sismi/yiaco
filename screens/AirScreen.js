...
const AirScreen = (props) => {
    return (
        <View style={{ flex: 1 }}>
            <View style={{ height: 55, justifyContent: 'center', paddingHorizontal: 5, backgroundColor: "green" }}>
            ...
            <ScrollView>
                <View style={{ flexDirection: 'row' }}>
                    <Image source={require('../assets/candy.jpg')} style={styles.indo}  >
                    </Image>
                    <Image source={require('../assets/zz.jpg')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}
                     onPress={() => props.navigation.navigate("FernScreen")}>Fern candy Plant</Text>
                    <Text style={styles.golden}
                      onPress={() => props.navigation.navigate("zamiaScreen")}>zamia zz plant</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium} onPress={() => props.navigation.navigate("AloveraScreen")}>Aloe Vera Mini Plant</Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Image source={require('../assets/sans.jpg')} style={styles.indo} >
                    </Image>
                    <Image source={require('../assets/indoor.jpg')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium} >Sansevieria Snake Plant</Text>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Image source={require('../assets/emina.jpg')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}>Syngonium Plant</Text>
                    <Text style={styles.golden}>Fern Emina Plant</Text>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.cashindoor}>$ 200</Text>
                    <Text style={styles.cash}>$ 90</Text>
