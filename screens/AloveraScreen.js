...
export default class AloveraScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/alovera.jpg")} style={{width: Dimensions.get('window').width, height: 300}} resizeMode="cover"/>
...
const dummyProduct = {
  ...
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/a/l/aloeveramini_eye_1.png',
  images: [
