...
export default class AnthuScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/anthu.jpg")}
...
const dummyProduct = {
  ...
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/a/n/anthurium_45.png',
  images: [
