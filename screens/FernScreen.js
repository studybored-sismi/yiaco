...
export default class FernScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/candy.jpg")} style={{width: Dimensions.get('window').width, height: 300}} resizeMode="cover"/>
