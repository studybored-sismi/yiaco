  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/indoor.jpg")} style={{width: Dimensions.get('window').width, height: 300}}
         resizeMode="cover"/>
...
const dummyProduct = {
  ...
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/m/o/moneygolden_45_1.png',
  images: [
