...
export default class aglonaScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/aglao.jpg")}
...
const dummyProduct = {
  ...
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/a/g/aglaonemared_45_2.png',
  images: [
