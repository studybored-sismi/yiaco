...
export default class hibiScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/hibis.jpg")}
...
const dummyProduct = {
  ...
  description: "Hibiscus are delightful shrubs with dark green leaves. Giving a hibiscus meant that the giver was acknowledging the receivers delicate beauty.",
  image:  '',
  images: [
