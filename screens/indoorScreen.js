        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Image source={require('../assets/drac.jpg')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}
                     onPress={() => props.navigation.navigate("MoneyScreen")}>     Money Plant Golden</Text>
                    <Text style={styles.golden} 
                     onPress={() => props.navigation.navigate("Golden")}>Dracaena Golden Plant</Text>
                </View>
                ...
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <Image source={require('../assets/choco1.png')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}>   Syngonium Pink Plant</Text>
                    <Text style={styles.golden}
                     onPress={() => navigation.navigate("medicalScreen")}>Chocolate Queen Plant</Text>
                </View>
                <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Image source={require('../assets/pep.jpg')} style={styles.indo} >
                    </Image>
                    <Image source={require('../assets/creep.png')} style={styles.Image} >
                    </Image>
                </View>
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}>Peperomia Green Plant</Text>
                    <Text style={styles.golden}>Peperomia Creeper Plant</Text>
                </View>
                <View style={{ flexDirection: 'row' }}>
                ...
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.anthurium}></Text>
                    <Text style={styles.golden}>Philodendron Xanadu plant</Text>
                </View>Boxwood Buxus Plant
                <View style={{ flexDirection: 'row' }}>
                    <Text style={styles.cashindoor}>$ 270</Text>
                    <Text style={styles.cash}>$ 90</Text>
                </View>
