...
export default class spiderScreen extends Component{
  ...
  render() {
    var left = (
      <Left style={{flex:1}}>
        <Button  transparent>
          <Icon name='ios-arrow-back' onPress={() => this.props.navigation.navigate("flowering")}  />
        </Button>
      </Left>
    );
    var right = (
...
const dummyProduct = {
  id: 2,
  title: 'SPIDER PLANT',
  description: "Chlorophytum Spider, also the Spider Plant is an impressive houseplant which is the perfect plant for any beginner. A NASA certified air purifier, its long, green foliage with white variegations look good in both hanging planters and as desktop setups. In favourable conditions, it blooms with small white flowers and its pups grow on hanging stems.",
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/c/h/chlorophytumspider_45_1.png',
  images: [
