...
export default class zamiaScreen extends Component{
  ...
  renderImages({item, index}) {
    return (
      <TouchableWithoutFeedback key={index} onPress={() => this.openGallery(index)}>
        <Image source={require("../assets/zz.jpg")} style={{width: Dimensions.get('window').width, height: 300}} resizeMode="contain"/>
...
const dummyProduct = {
  ...
  image:  'https://media.ugaoo.com/catalog/product/cache/81d2f56800d33f099d2b369affd8e374/4/5/45_1.png',
  images: [
